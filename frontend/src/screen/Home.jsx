    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black text-white">
        ...
        <div className="px-6 py-4 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="mt-4 md:mt-0 flex gap-3 items-center">
            ...
            <button
              ...
              from-blue-600 to-indigo-600 hover:scale-105 transition shadow-lg"
            >
              + New Project
            </button>
          </div>
            ...
            {filteredProjects
              ...
              .map((proj) => (
                <div
                  ...
                  className="group relative bg-white/10 backdrop-blur-md
                ...
                >
                  ...
                  from-blue-500/10 to-indigo-500/10 transition" />
                </div>
              ))}
          </div>
        )}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
          ...
          w-11/12 max-w-md p-6 border border-white/10">
            ...
            <form onSubmit={createProject}>
              <input
                ...
                className="w-full px-4 py-2 rounded-md bg-black/40
